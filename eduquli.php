...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function checkRowCount() {
        ...
        const isNextButtonEnabled = rowCount >= requiredRows;
        ...
        xhr.onload = function() {
            if (xhr.status !== 200) {
                console.error('Failed to update session:', xhr.statusText);
            }
        };
        xhr.send('isNextButtonEnabled=' + (isNextButtonEnabled ? 'true' : 'false'));
    }
